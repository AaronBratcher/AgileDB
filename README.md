...
## Getting Started ##
- The easiest way to use AgileDB is to use objects that adhere to the DBObject Protocol. This allows you to easily save or instantiate objects to/from the database.
